...
public class EmpleadoMapper {
    ...
    public EmpleadoResponse toResponse(Empleado emp) {
        return new EmpleadoResponse(emp.getId(), emp.getNombre(), emp.getApellido(), emp.getTelefono(), emp.getCorreo(), emp.getFechaNacimiento(), emp.getCargo().getNombre(), emp.getUsuarioId());
    }
}
